package com.retro.ethical.aniruddha.pingpong.model
...
import com.retro.ethical.aniruddha.pingpong.utils.*
import java.util.*
...
class PongTable : SurfaceView, SurfaceHolder.Callback {
    ...
    fun initPongTable(ctx: Context, attr: AttributeSet?) {
        ...
        // Set com.retro.ethical.aniruddha.pingpong.model.Ball
        val ballPaint = Paint()
